...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index.html" class="logo">
            ...
            <span class="logo-mini"><img width="50" height="50" src="{{URL::to('dist/img/d.png')}}" alt="Logo"></span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><img width="180" height="80" src="{{URL::to('dist/img/logo.png')}}" alt="Logo"></span>
        </a>
